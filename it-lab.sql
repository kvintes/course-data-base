...
-- Вывести все вершины на Алтае, высота которых более 3000 метров, 
...
where Регион ILIKE 'Алтай' and Высота > 3000 and Дата_завершения >= current_timestamp - interval '2 years';
; -- запрос проверки без каунта